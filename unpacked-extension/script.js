    ...
    if (isTimedOut()) {
      document.body.innerHTML = '' +
        '<style>' +
          ...
          'body > div > div { position: fixed; top: 0; right: 0; bottom: 0; left: 0; margin: auto; height: 60px; width: 60px; border: 2px solid #f00; border-radius: 50%; border-left-color: transparent; border-top-color: transparent; -webkit-animation: kill-netflix-timeouts-spinner 1s linear infinite }' +
